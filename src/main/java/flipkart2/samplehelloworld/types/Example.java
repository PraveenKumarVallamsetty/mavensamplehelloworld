package flipkart2.samplehelloworld.types;
...
public class Example extends AbstractType {
    ...
    public TypeElementBindingCollection getBindings() {
        return new TypeElementBindingCollection() {{
            add(new TypeElementBinding("Example", "An samplehelloworld service Type", getDeveloperName(), new TypeElementPropertyBindingCollection() {{
